...
$sql_u = "SELECT * FROM ea_listing_searched  WHERE customer_id = '$customerid' AND listing_id='$listingid'";
...
$sql = "INSERT INTO ea_listing_searched (customer_id,listing_id,created_at,updated_at)
