...
$sql = "INSERT INTO ea_conversation_message(conversation_id,seller_id,message,created_at,updated_at)
VALUES ('$conversationid','$sellerid','$msg','$created_at','$updated_at')";
