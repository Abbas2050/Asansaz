...
INNER JOIN ea_listing_searched ON ea_listing.listing_id = ea_listing_searched.listing_id)
WHERE ea_listing_searched.customer_id  = '$customerid'" ;
...
while($row=mysqli_fetch_array($responce))
    {
        ...
        $res=mysqli_query($con,$selectinner);
        if($res){
