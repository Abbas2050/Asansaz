                ...
                <?php if (options()->get('app.settings.common.disableStore', 0) == 0) { ?>
                    <div class="block">
                        ...
                        <div class="block-body collapse" id="company-block">
							...
							<div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                    <?= $form->field($modelCompany, 'company_about_us', [
                                        'template'      => '{input} {error}',
                                    ])->textarea([ 'placeholder' => t('app','Company No'), 'class' => ''])->label(false); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <?= $form->field($modelCompany, 'company_phone', [
                                        'template'      => '{input} {error}',
                                    ])->textInput([ 'placeholder' => t('app','Phone #'), 'class' => ''])->label(false); ?>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <?= $form->field($modelCompany, 'company_mobile', [
                                        'template'      => '{input} {error}',
                                    ])->textInput([ 'placeholder' => t('app','Mobile #'), 'class' => ''])->label(false); ?>
                                </div>
                            </div>
							<div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                   <label style="font-weight: bold">Logo:</label>
									<?= $form->field($modelCompany, 'company_logo', [
                                        'template'      => '{input} {error}',
                                    ])->fileInput(['class' => '']); ?>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <label style="font-weight: bold">Banner:</label>
									<?= $form->field($modelCompany, 'company_banner', [
                                        'template'      => '{input} {error}',
                                    ])->fileInput(['class' => '']); ?>
                                </div>
                            </div>
