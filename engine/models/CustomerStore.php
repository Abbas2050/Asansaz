...
class CustomerStore extends \app\models\auto\CustomerStore
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_name', 'company_name','company_about_us','company_logo','company_phone','company_mobile','company_banner'], 'required'],
            [['company_logo','company_banner'], 'file', 'extensions' => 'png, jpg, jpeg'],
            [['store_name', 'company_name','company_phone','company_mobile'], 'string', 'max' => 30],
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'company_mobile'  => t('app', 'Mobile'),
            'company_phone'   => t('app', 'Phone'),
            'company_banner'  => t('app', 'Banner'),
			'company_logo'    => t('app', 'logo'),
            'company_about_us'=> t('app', 'About Us'),
        ]);
    }
